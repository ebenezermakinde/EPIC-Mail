...
var _dummyMessages = _interopRequireDefault(require("../utils/dummyMessages"));

var _mockMessage = require("./mockMessage/mockMessage");
...
describe('Emails test', function () {
  describe('GET', function () {
    describe('Get all recieved emails', function () {
    ...
    describe('Get one email', function () {
  ...
  describe('POST', function () {
    describe('Send a valid email', function () {
      it('should return status code 200 and send email', function (done) {
        _chai.default.request(_server.default).post('/api/v1/messages').send(_mockMessage.validPostData[0]).end(function (err, res) {
    ...
    describe('Sending an email with empty subject', function () {
      it('should return status code 400 and send an error message', function (done) {
        _chai.default.request(_server.default).post('/api/v1/messages').send(_mockMessage.invalidPost[0]).end(function (err, res) {
    ...
    describe('Sending an email with empty message', function () {
      it('should return status code 400 and send an error message', function (done) {
        _chai.default.request(_server.default).post('/api/v1/messages').send(_mockMessage.invalidPost[1]).end(function (err, res) {
          res.should.have.status(400);
          res.body.should.be.a('object');
          res.body.should.have.property('status');
          res.body.should.have.property('error');
  ...
  describe('DELETE', function () {
    describe('Delete an email id that is present', function () {
      it('should return status code 200 and remove message', function (done) {
        ...
        _chai.default.request(_server.default).delete("/api/v1/messages/".concat(id)).send(_dummyMessages.default).end(function (err, res) {
          res.should.have.status(200);
          res.body.should.be.a('object');
          res.body.should.have.property('status');
          res.body.should.have.property('data');
...
//# sourceMappingURL=messeage.test.js.map