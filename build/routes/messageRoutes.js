...
var _messageValidator = _interopRequireDefault(require("../middleware/messageValidator"));

var _findEmailById = require("../middleware/findEmailById");
...
messageRouter.delete('/:messageId', _findEmailById.findEmailById, _messageController.deleteEmail);
messageRouter.get('/:messageId', _findEmailById.findEmailById, _messageController.getOneEmail);
